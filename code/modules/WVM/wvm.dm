...
/obj/machinery/mineral/wasteland_vendor/attachments
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Hydraulic-Assisted Grip",		/obj/item/gun_upgrade/mechanism/better,							40),
		new /datum/data/wasteland_equipment("Super-Stable Grip",			/obj/item/tool_upgrade/refinement/stabilized_grip,				40),
